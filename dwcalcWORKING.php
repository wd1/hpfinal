      ...
      var daty=data;
        ...
        html2canvas(x, {
          onrendered: function (canvas) {
            ...
            //document.write('<a target="_blank" class="downloadsingle" download><img src="'+imgorig+'"/></a>');     
        
            //$('.downloadsingle').trigger('click');
            $.ajax({
...
$(document).on('click', '.dwdowngif', function(){
  //$content = file_get_contents(window.location.href);
