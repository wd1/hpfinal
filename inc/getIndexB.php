...
if($background=='image'){
	if($type=='Video'){
		...
		$final=$final."<li class='lefter'><a href='".$url."'><img src='admin/uploads/image/".$img."'/><img class='draft bigdraft' src='img/draft.png'/><div class='".$hidetitle." title-block bigtitle' style='background:".$colgb."'>".$type."</div><div class='".$colas." lip-block biglip'><div class='lip-txt hnews'>".$pagetitle."</div><div class='lip-date ".$hidedate."'>".$dater."</div></div></a></li>";
	}else if($type=='News'){
		$final=$final."<li class='lefter'><a href='i?url=".$url."&o=".$offset."'><img src='admin/uploads/image/".$img."'/><img class='draft bigdraft' src='img/draft.png'/><div class='".$hidetitle." title-block bigtitle' style='background:".$colgb."'>".$type."</div><div class='".$colas." lip-block biglip'><div class='lip-txt hnews'>".$pagetitle."</div><div class='lip-date ".$hidedate."'>".$dater."</div></div></a></li>";
	}else if($type=='Announcement'||$type=='Exclusive'){
		$final=$final."<li class='lefter'><a href='article.php?p=".$pageid."'><img src='admin/uploads/image/".$img."'/><img class='draft bigdraft' src='img/draft.png'/><div class='".$hidetitle." title-block bigtitle' style='background:".$colgb."'>".$type."</div><div class='".$colas." lip-block biglip'><div class='lip-txt hnews'>".$pagetitle."</div><div class='lip-date ".$hidedate."'>".$dater."</div></div></a></li>";	
	}	
} else{
	if($type=='Video'){
...
if($background=='image'){
	...
	if($type=='Video'){
		...
		$final=$final."<li class='have' style='background:".$color."'><a href='".$url."'><img class='draft' style='visibility:hidden' src='img/draft.png'/><div class='".$hidetitle." title-sblock'>".$type."</div><div class='lip-sblock'><div class='lip-stit'>".$pagetitle."</div><div class='lip-subtit'>".$subtitle."</div><div class='lip-sdate ".$hidedate."'>".$dater."</div></div></a></li>";
	}else if($type=='News'){
...
if($background=='image'){
	if($type=='Video'){
		...
		$final=$final."<li class='last have'><a href='".$url."'><img src='admin/uploads/image/".$img."'/><img class='draft' src='img/draft.png'/><div class='".$hidetitle." title-block' style='background:".$colgb."'>".$type."</div><div class='".$colas." lip-block'><div class='lip-txt hnews'>".$pagetitle."</div><div class='lip-date ".$hidedate."'>".$dater."</div></div></a></li></ul>";
	}else if($type=='News'){
		$final=$final."<li class='last have'><a href='i?url=".$url."&o=".$offset."'><img src='admin/uploads/image/".$img."'/><img class='draft' src='img/draft.png'/><div class='".$hidetitle." title-block' style='background:".$colgb."'>".$type."</div><div class='".$colas." lip-block'><div class='lip-txt hnews'>".$pagetitle."</div><div class='lip-date ".$hidedate."'>".$dater."</div></div></a></li></ul>";
	}else if($type=='Announcement'||$type=='Exclusive'){
		$final=$final."<li class='last have'><a href='article.php?p=".$pageid."'><img src='admin/uploads/image/".$img."'/><img class='draft' src='img/draft.png'/><div class='".$hidetitle." title-block' style='background:".$colgb."'>".$type."</div><div class='".$colas." lip-block'><div class='lip-txt hnews'>".$pagetitle."</div><div class='lip-date ".$hidedate."'>".$dater."</div></div></a></li></ul>";	
	}	
} else{
	if($type=='Video'){
